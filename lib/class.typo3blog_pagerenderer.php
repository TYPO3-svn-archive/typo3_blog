 ...
 */
class typo3blog_pagerenderer
{
	public $conf = array();
	public $extKey = 'typo3blog';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/typo3_blog/lib/class.typo3blog_pagerenderer.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/typo3_blog/lib/class.typo3blog_pagerenderer.php']);
}
